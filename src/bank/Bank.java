...
public class Bank {
	...
	public void accountReport(AccountReport accountReport){
		for (Product product : products){
			product.accept(accountReport);
		}
	}
	
	public void showReportResult(AccountReport accountReport){
		
	}
	
	public void showReportResultQuantity(AccountReport accountReport){
		System.out.println("" + accountReport.getProducts().size());
	}
}
